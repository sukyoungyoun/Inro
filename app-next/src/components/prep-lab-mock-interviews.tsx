...
export function PrepLabMockInterviews({
  ...
  return (
    <>
      ...
      <aside
        className="brief-sidebar inro_mock_interviews"
        role="complementary"
      ...
      >
        ...
        <div className="prep-lab-start-block">
          <Link href={`/sessions/${sessionId}/practice?q=0`} className="mock-btn prep-start-full-btn">
            Start full session →
          </Link>
          <p className="prep-start-full-hint">
            {total > 0 ? `Practice all ${total} questions in order` : "Practice all questions in order once they are generated"}
          </p>
